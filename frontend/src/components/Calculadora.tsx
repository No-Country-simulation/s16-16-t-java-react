...
export default function Calculadora() {
  ...
  return (
    <div className='flex-col justify-start items-start gap-16 inline-flex mt-16  '>
      <div className="w-[337px] h-[29px]  flex justify-start ">
        <Link to={'/'} className="text-[#f9f9f9] text-base font-bold font-['Open Sans'] cursor-pointer">Inicio / </Link>
        <Link to={'/designGuide'} className="cursor-pointer text-[#16afe0] text-base font-bold font-['Open Sans']">Guía de diseño.</Link>
      </div>
