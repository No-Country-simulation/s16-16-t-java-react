...
export default function ResumenVarios() {
  ...
  return (
    ...
    <div className="w-[342px] h-[521px] left-[742px] top-[242px] absolute">
  ...
  <div className="w-[159px] h-[247px] left-0 top-[41px] absolute flex-col justify-start items-start gap-4 inline-flex">
    <div className="self-stretch text-white text-lg font-normal font-['Open Sans'] leading-snug -ml-[108px]">4 Item</div>
    <div>
  ...
  <div className=" left-0 top-[312px] absolute   flex-col justify-start items-start gap-2 inline-flex">
    <img className="w-[159px] h-[209px]" src="/src/assets/img/card-checkout-resumen.png" />
    <div className="px-2 py-4  justify-center items-center gap-2.5 inline-flex">
    </div>
  </div>

  <div className="left-[183px] top-[79px] absolute   flex-col justify-start items-start gap-2 inline-flex">
  <img className="w-[159px] h-[209px]" src="/src/assets/img/card-checkout-resumen.png" />
  <div className="px-2 py-4  justify-center items-center gap-2.5 inline-flex">
    </div>
  </div>
  <div className="left-[183px] top-[312px] absolute  flex-col justify-start items-start gap-2 inline-flex">
  <img className="w-[159px] h-[209px]" src="/src/assets/img/card-checkout-resumen.png" />
    <div className="px-2 py-4  justify-center items-center gap-2.5 inline-flex">
